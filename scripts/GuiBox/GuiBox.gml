...
function GuiBox(_x1, _y1, _x2, _y2) constructor {
    ...
    static set_x1 = function(_x1) {
        if !is_real(_x1) {
            throw(instanceof(self) + ".set_x1() \"_x1\" expected a Number, received " + typeof(_x1) + ".");
        }
        x1 = _x1;
        return self;
    }
    ...
    static set_y1 = function(_y1) {
        if !is_real(_y1) {
            throw(instanceof(self) + ".set_y1() \"_y1\" expected a Number, received " + typeof(_y1) + ".");
        }
        y1 = _y1;
        return self;
    }
    ...
    static set_x2 = function(_x2) {
        if !is_real(_x2) {
            throw(instanceof(self) + ".set_x2() \"_x2\" expected a Number, received " + typeof(_x2) + ".");
        }
        x2 = _x2;
        return self;
    }
    ...
    static set_y2 = function(_y2) {
        if !is_real(_y2) {
            throw(instanceof(self) + ".set_y2() \"_y2\" expected a Number, received " + typeof(_y2) + ".");
        }
        y2 = _y2;
        return self;
    }
