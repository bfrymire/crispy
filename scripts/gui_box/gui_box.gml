function gui_box(_x1, _y1, _x2, _y2) constructor {
    ...
    set_x1 = function(_x1) {
        if !is_real(_x1) {
            crispy_throw_expected(self, "set_x1", "real", typeof(_x1));
        }
        x1 = _x1;
    }
    ...
    set_y1 = function(_y1) {
        if !is_real(_y1) {
            crispy_throw_expected(self, "set_y1", "real", typeof(_y1));
        }
        y1 = _y1;
    }
    ...
    set_x2 = function(_x2) {
        if !is_real(_x2) {
            crispy_throw_expected(self, "set_x2", "real", typeof(_x2));
        }
        x2 = _x2;
    }
    ...
    set_y2 = function(_y2) {
        if !is_real(_y2) {
            crispy_throw_expected(self, "set_y2", "real", typeof(_y2));
        }
        y2 = _y2;
    }
